...
import { gameHeight } from '../scenes/main-scene';
...
export default class ScoreObject {
  ...
  constructor(scene: Phaser.Scene) {
    ...
    this.scene.add.text(20, gameHeight - 42.5, 'Score :', this.textStyle);
    // 初期値を与える
    this.score = 0;
    // スコア表示
    this.scoreText = this.scene.add.text(250, gameHeight - 42.5, String(this.score), this.textStyle).setOrigin(1, 0);  // 右揃え
  }
